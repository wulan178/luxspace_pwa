...
export default function Profile() {
    ...
    async function subscribe() {
        const key = "BKTMp7CNQbnJS5I9crHq555cnzRkUO7b4Sr-aEOaylYRFEeR7V8QMS-fwR0uMOBXCCaBZrqyz6zvd5H6UA5G5Qs";
                    ...
                    <div className="flex flex-stretch items-center">
                        ...
                        <div className="w-auto">
                            <ul className="items-center flex">
                                ...
                                <li className="ml-6">
                                    <a id="header-cart" href="/" className="flex items-center justify-center w-8 h-8 text-black cart cart-filled">
                                        <svg
